...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func rememberUser() {
        ...
        if user != nil {
            ...
            let tableVC = board.instantiateViewController(withIdentifier: "revealVC") as UIViewController
            window?.rootViewController = tableVC
            
        } else {
            
            let board : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
            let signIn = board.instantiateViewController(withIdentifier: "signInVC")
